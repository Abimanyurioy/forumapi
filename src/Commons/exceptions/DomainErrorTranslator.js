...
DomainErrorTranslator._directories = {
  ...
  "ADD_THREAD.PROPERTY_HAVE_WRONG_DATA_TYPE": new InvariantError(
    "tidak bisa membuat thread, payload tipe data salah"
  ),
  "ADD_THREAD.TITLE_EXCEED_CHAR_LIMIT": new InvariantError(
    "title Exceed char limit 100"
  ),
  "ADD_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY": new InvariantError(
    "cannot make a new comment, payload not correct"
  ),
  "ADD_COMMENT.PROPERTY_HAVE_WRONG_DATA_TYPE": new InvariantError(
  ...
  "ADD_REPLIES.PROPERTY_HAVE_WRONG_DATA_TYPE": new InvariantError(
    "cannot make a new comment, payload property have wrong data type"
  ),
